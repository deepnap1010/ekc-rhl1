...
export interface IAppConfig {
  ...
  // Downtime-reason popup rules (when to ask, how long, which reasons).
  // Shape owned + validated by utils/downtimeAsk.ts; stored as-is here.
  downtimeAsk?: Record<string, unknown>;
